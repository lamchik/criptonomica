          ...
          <div class="max-w-xs">
            ...
            <div class="mt-1 relative rounded-md shadow-md mb-1">
              <input
                ...
                name="wallet"
                id="wallet"
                class="p-2.5 block w-full pr-10 border-gray-300 text-gray-900 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm rounded-md"
...
export default {
  ...
  computed: {
    tools: function() {
      const res = Object.keys(this.coinlist).filter(tic => {
        return tic.includes(this.ticker);
      });
      if (res.length > 4) {
